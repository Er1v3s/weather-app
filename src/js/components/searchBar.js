const SearchBar = () => {
  ...
  searchBar.innerHTML = `
    ...
    <div class="absolute w-[100%] h-[100%] flex justify-center items-center
        ...
        <span class="text-zinc-800 text-xl"><i class="fa-solid fa-magnifying-glass"></i></span>
        </div>
        <input type="text"
            class="block w-[90%] text-center text-2xl bg-transparent border-b-2 border-zinc-800 placeholder-zinc-700 focus:outline-none" placeholder="Search">
    </div>
  `;
